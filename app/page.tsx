...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-off-white">
      ...
      <section className="bg-gradient-to-r from-dark-gray via-bright-red to-orange text-white hero-section">
      ...
      <div className="container-main py-8">
        <div className="grid-sidebar">
          ...
          {/* Right Sidebar - Enhanced Content - Reduced Padding */}
          <div className="lg:col-span-3">
            <div className="space-y-4">
              {/* Recent Results */}
              <Card className="sidebar-compact">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-heading">Recent Results</h3>
                  <Link href="/results" className="link-primary text-xs">View All</Link>
                </div>
                <div className="space-y-2">
                  {recentResults.slice(0, 3).map((result) => (
                    <div key={result.id} className="p-2.5 bg-off-white rounded-lg">
                      ...
                      {result.scoreA !== null && result.scoreB !== null && (
                        <div className="text-base font-bold text-bright-red text-center">
              ...
              {recentNews.length > 0 && (
                <Card className="sidebar-compact">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Link href="/notices" className="link-primary text-xs">View All</Link>
                  </div>
                  <div className="space-y-2">
                    {recentNews.map((news) => (
                      <div key={news.id} className="p-2.5 bg-off-white rounded-lg">
                        <div className="text-caption mb-1">
              ...
              <Card className="sidebar-compact">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-heading">Latest Notices</h3>
                  <Link href="/notices" className="link-primary text-xs">View All</Link>
                </div>
                <div className="space-y-2">
                  {recentNotices.slice(0, 3).map((notice) => (
                    <div key={notice.id} className="p-2.5 bg-off-white rounded-lg">
                      <div className="text-caption mb-1">
              ...
              {/* Contact Info */}
              <div className="bg-bright-red text-white rounded-lg p-4">
                <h3 className="text-heading mb-3">Get in Touch</h3>
                <div className="space-y-2 text-sm">
              ...
              <Card className="sidebar-compact">
                <h3 className="text-heading mb-3">Upcoming Events</h3>
                <div className="space-y-2">
                  <div className="p-2.5 bg-gradient-to-r from-orange to-bright-red text-white rounded-lg">
                    <div className="text-xs opacity-90">Next Week</div>
                    <div className="font-medium text-sm">District Championship</div>
                  </div>
                  <div className="p-2.5 bg-gradient-to-r from-dark-gray to-medium-gray text-white rounded-lg">
                    <div className="text-xs opacity-90">This Month</div>
                    <div className="font-medium text-sm">Training Camp</div>
                  </div>
                </div>
                <Link href="/events" className="link-primary text-xs block text-center mt-3">
                  View All Events →
                </Link>
              </Card>
            </div>
