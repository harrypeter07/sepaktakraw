...
export function GovHeader() {
  return (
    <header className="border-b border-medium-gray bg-white">
      <div className="container-content py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <Link href="/" className="font-semibold text-dark-gray text-lg">Maharashtra Sepaktakraw Association</Link>
